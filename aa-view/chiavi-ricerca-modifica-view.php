    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?=URLBASE; ?>chiavi.php/modifica/<?=$chiave['record_id']; ?>" method="POST">
