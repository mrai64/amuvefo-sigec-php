    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?=URLBASE; ?>vocabolario.php/aggiungi/<?=$chiave; ?>" method="post">
              <div class="mb-3">
              ...
              <div class="mb-3">
                <button type="submit" name="aggiungi_vocabolario" class="btn btn-primary">Aggiungi al vocabolario</button>
              </div>
            </form>
          </div>
        </div>
