...
<html lang="it">
  <head>
    ...
    <title>DINIEGO Richiesta evasa | modifica </title>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="<?=$url_aggiorna_richiesta; ?>" method="POST">
          ...
          <div class="mb-3">
            <button type="submit" name="rifiuto_richiesta" class="btn btn-primary">Visto, si rifiuta</button>
          </div>
        </form>        
      </div>
    </div>
