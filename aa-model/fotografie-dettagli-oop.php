<?php
/**
 * @source /aa-model/fotografie-dettagli-oop.php
 * @author Massimo Rainato <maxrainato@libero.it>
 *
 * Classe FotografieDettagli
 *
 *	dipendenze: DatabaseHandler connessione archivio PDO
 *	dipendenze: Fotografie tabella padre
 *	dipendenze: Descrizioni tabella di lunghi testi
 *
 * Per ogni fotografia i dati associati non dovrebbero essere
...
Class FotografieDettagli {
	...
	public function set_record_id_padre( int $record_id_padre ){
		...
		// TODO: si può aggiungere un check se presente in tabella_padre Fotografie
	}
