<?php 
/**
 * @source /aa-controller/ricerche-v2-controller.php
...
function nuova_ricerca_semplice(array $dati_input) {
	...
	header("Location: ".URLBASE."ricerche-v2.php/leggi/".$ricerca_id );
	exit(0);
...
function leggi_ricerca(int $ricerca_id) {
	...
	// e alla fine mostro
	require_once(ABSPATH.'aa-view/ricerca-v2-risultati-view.php');
	exit(0);
